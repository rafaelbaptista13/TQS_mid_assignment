...
public class ByDayTest {
  ...
  public void byday() {
    ...
    driver.findElement(By.id("lat-input")).click();
    driver.findElement(By.id("lat-input")).sendKeys("12");
    driver.findElement(By.id("lon-input")).click();
    driver.findElement(By.id("lon-input")).sendKeys("73");
    driver.findElement(By.id("day-date-input")).click();
    driver.findElement(By.id("day-date-input")).sendKeys("2021-05-09");
    driver.findElement(By.cssSelector(".btn")).click();
    {
      WebDriverWait wait = new WebDriverWait(driver, 30);
      wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("p:nth-child(1)")));
    }
    assertThat(driver.findElement(By.cssSelector("p:nth-child(1) > strong:nth-child(1)")).getText(), is("12"));
    assertThat(driver.findElement(By.cssSelector("strong:nth-child(2)")).getText(), is("73"));
    assertThat(driver.findElement(By.cssSelector("strong:nth-child(3)")).getText(), is("2021-05-09"));
  ...
  public void byDayInvalidCoords() {
    ...
    driver.findElement(By.linkText("Search Air Quality on a specific day")).click();
    driver.findElement(By.id("lat-input")).click();
    driver.findElement(By.id("lat-input")).sendKeys("200");
    driver.findElement(By.id("lon-input")).sendKeys("200");
    driver.findElement(By.id("day-date-input")).click();
    driver.findElement(By.id("day-date-input")).sendKeys("2021-05-09");
    driver.findElement(By.cssSelector(".btn")).click();
    {
    ...
    assertThat(driver.findElement(By.id("error")).getText(), is("Air Quality results not found for the given parameters."));
  }
}
